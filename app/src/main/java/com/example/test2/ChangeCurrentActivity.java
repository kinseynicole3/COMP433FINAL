...
public class ChangeCurrentActivity extends AppCompatActivity {
    Cursor c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_current);
    ...
    public void setButtonsInLayout() {
        c = mDatabase.rawQuery("SELECT * from Meds", null);
        TextView tv = findViewById(R.id.no_meds_change);
